  ...
  return (
    <section id="designs" className="py-24 md:py-32 relative">
      <div className="container">
        ...
        >
          <span className="inline-block glass rounded-full px-4 py-1 text-xs font-medium mb-5">Demo website designs</span>
              ...
              >
                ...
                <div className="p-5">
                  <div className="flex items-start justify-between gap-3 mb-2">
                    ...
                    <span className="text-[10px] uppercase tracking-wider glass rounded-full px-2.5 py-1 text-muted-foreground">{d.tag}</span>
                  </div>
